...
class SCNManager:
    ...
    RPC_IP_ADDRESS         = "172.18.128.1"
    RPC_INITIAL_IP_ADDRESS = "172.18.128.1"
    ...
    def modify_overlay(self, overlay_name, overlay_id, code_spec):
        """オーバレイ変更API
        overlay_name -- [str]  オーバレイ名
        ...
        """
        try:
            self._client.call('modify_overlay', overlay_name, overlay_id, code_spec)
